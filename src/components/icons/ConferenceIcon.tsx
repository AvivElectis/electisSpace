...
/**
 * Conference Room Icon Component
 * Custom SVG icon that integrates with Material-UI
 * Represents a conference/meeting room with people
 */
export function ConferenceIcon(props: SvgIconProps) {
    return (
        <SvgIcon
            {...props}
            viewBox="0 0 24 24"
            sx={{
                '& path': {
                    ...
                    strokeWidth: .85,  // Thickness (try 0.3-1.0)
                    strokeLinejoin: 'smooth',  // Smooth corners
                    strokeLinecap: 'smooth',  // Smooth line ends
                    fill: 'currentColor',  // Also fill the shape
                },
                ...props.sx
            }}
        >
