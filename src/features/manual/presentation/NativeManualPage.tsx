 ...
 * NativeManualPage
 *
 * Full-page version of ManualDialog for native (Android/iOS) builds.
 * - Blue header bar with back arrow + title + safe-area padding
 * - Contact & Info tab and Manual tab with sub-tabs (same content as ManualDialog)
 */
...
export function NativeManualPage() {
    ...
    return (
        <Box sx={{ minHeight: '100vh', bgcolor: 'background.default', display: 'flex', flexDirection: 'column' }}>
            ...
            <Box sx={{ px: { xs: 1, sm: 2 }, bgcolor: 'background.paper' }}>
                <Tabs
                    value={mainTab}
