...
import { compassSpaceRoutes, compassBuildingRoutes, adminCompassSpaceRoutes, adminCompassBuildingRoutes } from './features/compass-spaces/index.js';
...
apiRouter.use('/admin/compass/buildings', adminCompassBuildingRoutes);
